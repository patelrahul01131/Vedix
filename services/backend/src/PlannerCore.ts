...
const PLAN_RETRY_TIMEOUT_MS = 15_000;
...
Step rules:
  ...
  - STRICT VERIFICATION RULE: For every 'write_file', 'edit_file', or 'create_file' step, the IMMEDIATE next step MUST be a verification step (e.g., using 'run_command' to run tests or 'node -c') to confirm the change before proceeding.
