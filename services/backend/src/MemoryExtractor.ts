...
- NO TEMPORARY PATHS OR PROJECTS RULE: NEVER extract absolute file paths, current working directories, temporary workspace names, or one-off sibling project locations (e.g., "User works in /Users/.../Check" or "User has Jarvix project"). These are temporary spatial contexts and MUST NOT be stored in PROFILE or any long-term memory. Limit PROFILE to facts like User Name, Company, or Job Role.
